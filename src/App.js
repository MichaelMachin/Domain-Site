  ...
  return (
    <div>
      ...
      <div className='cards__section'>
        ...
        <h2 className='cards__title'>Why you need a domian name.</h2>
        <p className='cards__description'>
          Own your custon username, use it across services, and be able to store an avatar and other profile data.
        </p>
